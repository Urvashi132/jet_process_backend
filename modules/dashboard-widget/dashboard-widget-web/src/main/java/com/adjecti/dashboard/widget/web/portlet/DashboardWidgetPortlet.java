...
@Component(immediate = true, property = { "com.liferay.portlet.display-category=category.sample",
		...
		"javax.portlet.display-name=DashboardWidget", "javax.portlet.init-param.template-path=/",
...
public class DashboardWidgetPortlet extends MVCPortlet {
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		List<DashboardWidget> allDashboardWidgets = DashboardWidgetLocalServiceUtil
				.getDashboardWidgets(QueryUtil.ALL_POS, QueryUtil.ALL_POS);
	...
	public void addWidgetToPage(ActionRequest request, ActionResponse response) throws PortalException {
		...
		String portletId = request.getParameter("portletName");
		System.out.println("portletName  " + portletId);
