...
public class DashboardWidgetModelListener extends BaseModelListener<DashboardWidget> {
	...
	public void onAfterCreate(DashboardWidget model) throws ModelListenerException {
		...
		try {
			...
			//setAddToPagePermissions(model.getPortletName());
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	/*
	 * public static void setAddToPagePermissions(String portletId) throws Exception
	 * { long companyId = PortalUtil.getDefaultCompanyId();
	 * 
	 * Role roleEmployee = RoleLocalServiceUtil.getRole(companyId, "Employee");
	 * Portlet portlet = PortletLocalServiceUtil.getPortletById(portletId);
	 * ResourcePermissionLocalServiceUtil.addResourcePermission(companyId,
	 * portletId, ResourceConstants.SCOPE_GROUP,
	 * String.valueOf(portlet.getPrimaryKey()) , roleEmployee.getRoleId(),
