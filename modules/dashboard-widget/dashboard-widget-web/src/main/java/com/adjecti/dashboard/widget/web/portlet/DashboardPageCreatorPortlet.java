...
@Component(immediate = true, property = { "com.liferay.portlet.display-category=category.sample",
		...
		"javax.portlet.display-name=Dashboard Page Creator Portlet", "javax.portlet.init-param.template-path=/",
...
public class DashboardPageCreatorPortlet extends MVCPortlet {
	...
	public void addPageAction(ActionRequest request, ActionResponse response) throws PortletException, PortalException {
		...
		Layout layout = LayoutLocalServiceUtil.getLayoutByFriendlyURL(groupId, false, "/dashboard-template");
		try {
