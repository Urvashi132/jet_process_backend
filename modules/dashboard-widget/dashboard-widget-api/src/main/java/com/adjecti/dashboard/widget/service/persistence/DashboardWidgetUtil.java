...
/**
 * The persistence utility for the dashboard widget service. This utility wraps <code>com.adjecti.dashboard.widget.service.persistence.impl.DashboardWidgetPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see DashboardWidgetPersistence
 * @generated
 */
public class DashboardWidgetUtil {
	 ...
	 */
	public static void clearCache(DashboardWidget dashboardWidget) {
		getPersistence().clearCache(dashboardWidget);
	}
	 ...
	 */
	public static Map<Serializable, DashboardWidget> fetchByPrimaryKeys(
	 ...
	 */
	public static List<DashboardWidget> findWithDynamicQuery(
	 ...
	 */
	public static DashboardWidget update(DashboardWidget dashboardWidget) {
		return getPersistence().update(dashboardWidget);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static DashboardWidget update(
		DashboardWidget dashboardWidget, ServiceContext serviceContext) {

		return getPersistence().update(dashboardWidget, serviceContext);
	}
	 ...
	 */
	public static List<DashboardWidget> findByUuid(String uuid) {
	 ...
	 */
	public static List<DashboardWidget> findByUuid(
	 ...
	 */
	public static DashboardWidget findByUuid_First(
			String uuid, OrderByComparator<DashboardWidget> orderByComparator)
		throws com.adjecti.dashboard.widget.exception.
			NoSuchDashboardWidgetException {
	 ...
	 */
	public static DashboardWidget fetchByUuid_First(
		String uuid, OrderByComparator<DashboardWidget> orderByComparator) {
	 ...
	 * @throws NoSuchDashboardWidgetException if a matching dashboard widget could not be found
	 */
	public static DashboardWidget findByUuid_Last(
			String uuid, OrderByComparator<DashboardWidget> orderByComparator)
		throws com.adjecti.dashboard.widget.exception.
			NoSuchDashboardWidgetException {
	 ...
	 */
	public static DashboardWidget fetchByUuid_Last(
		String uuid, OrderByComparator<DashboardWidget> orderByComparator) {
	 ...
	 */
	public static DashboardWidget[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			dashboardWidgetId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchDashboardWidgetException if a matching dashboard widget could not be found
	 */
	public static DashboardWidget findByUUID_G(String uuid, long groupId)
		throws com.adjecti.dashboard.widget.exception.
			NoSuchDashboardWidgetException {
	 ...
	 */
	public static DashboardWidget fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching dashboard widget, or <code>null</code> if a matching dashboard widget could not be found
	 */
	public static DashboardWidget fetchByUUID_G(
	 ...
	 */
	public static DashboardWidget removeByUUID_G(String uuid, long groupId)
		throws com.adjecti.dashboard.widget.exception.
			NoSuchDashboardWidgetException {
	 ...
	 * @return the matching dashboard widgets
	 */
	public static List<DashboardWidget> findByUuid_C(
	 ...
	 * @throws NoSuchDashboardWidgetException if a matching dashboard widget could not be found
	 */
	public static DashboardWidget findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<DashboardWidget> orderByComparator)
		throws com.adjecti.dashboard.widget.exception.
			NoSuchDashboardWidgetException {
	 ...
	 * @return the first matching dashboard widget, or <code>null</code> if a matching dashboard widget could not be found
	 */
	public static DashboardWidget fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<DashboardWidget> orderByComparator) {
	 ...
	 * @throws NoSuchDashboardWidgetException if a matching dashboard widget could not be found
	 */
	public static DashboardWidget findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<DashboardWidget> orderByComparator)
		throws com.adjecti.dashboard.widget.exception.
			NoSuchDashboardWidgetException {
	 ...
	 * @return the last matching dashboard widget, or <code>null</code> if a matching dashboard widget could not be found
	 */
	public static DashboardWidget fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<DashboardWidget> orderByComparator) {
	 ...
	 * @throws NoSuchDashboardWidgetException if a dashboard widget with the primary key could not be found
	 */
	public static DashboardWidget[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			dashboardWidgetId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @throws NoSuchDashboardWidgetException if a matching dashboard widget could not be found
	 */
	public static DashboardWidget findByportletName(String portletName)
		throws com.adjecti.dashboard.widget.exception.
			NoSuchDashboardWidgetException {

		return getPersistence().findByportletName(portletName);
	}
	 ...
	 * @return the matching dashboard widget, or <code>null</code> if a matching dashboard widget could not be found
	 */
	public static DashboardWidget fetchByportletName(String portletName) {
		return getPersistence().fetchByportletName(portletName);
	}
	 ...
	 * @return the matching dashboard widget, or <code>null</code> if a matching dashboard widget could not be found
	 */
	public static DashboardWidget fetchByportletName(
		String portletName, boolean useFinderCache) {

		return getPersistence().fetchByportletName(portletName, useFinderCache);
	}
	 ...
	 * @return the dashboard widget that was removed
	 */
	public static DashboardWidget removeByportletName(String portletName)
		throws com.adjecti.dashboard.widget.exception.
			NoSuchDashboardWidgetException {

		return getPersistence().removeByportletName(portletName);
	}
	 ...
	 * @return the number of matching dashboard widgets
	 */
	public static int countByportletName(String portletName) {
		return getPersistence().countByportletName(portletName);
	}
	 ...
	 */
	public static void cacheResult(DashboardWidget dashboardWidget) {
		getPersistence().cacheResult(dashboardWidget);
	}
	 ...
	 */
	public static void cacheResult(List<DashboardWidget> dashboardWidgets) {
		getPersistence().cacheResult(dashboardWidgets);
	}
	 ...
	 */
	public static DashboardWidget create(long dashboardWidgetId) {
		return getPersistence().create(dashboardWidgetId);
	}
	 ...
	 * @throws NoSuchDashboardWidgetException if a dashboard widget with the primary key could not be found
	 */
	public static DashboardWidget remove(long dashboardWidgetId)
		throws com.adjecti.dashboard.widget.exception.
			NoSuchDashboardWidgetException {

		return getPersistence().remove(dashboardWidgetId);
	}

	public static DashboardWidget updateImpl(DashboardWidget dashboardWidget) {
		return getPersistence().updateImpl(dashboardWidget);
	}
	 ...
	 * @throws NoSuchDashboardWidgetException if a dashboard widget with the primary key could not be found
	 */
	public static DashboardWidget findByPrimaryKey(long dashboardWidgetId)
		throws com.adjecti.dashboard.widget.exception.
			NoSuchDashboardWidgetException {

		return getPersistence().findByPrimaryKey(dashboardWidgetId);
	}
	 ...
	 */
	public static DashboardWidget fetchByPrimaryKey(long dashboardWidgetId) {
		return getPersistence().fetchByPrimaryKey(dashboardWidgetId);
	}
	 ...
	 */
	public static List<DashboardWidget> findAll() {
	 ...
	 */
	public static List<DashboardWidget> findAll(int start, int end) {
	...
	public static DashboardWidgetPersistence getPersistence() {
		return _persistence;
	}

	private static volatile DashboardWidgetPersistence _persistence;
