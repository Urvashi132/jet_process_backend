...
public class DashboardWidgetLocalServiceWrapper
	...
	public com.adjecti.dashboard.widget.model.DashboardWidget
		...
		return _dashboardWidgetLocalService.addDashboardWidget(
			portletName, thumbnail, added);
	}
	...
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _dashboardWidgetLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _dashboardWidgetLocalService.dslQueryCount(dslQuery);
	}
