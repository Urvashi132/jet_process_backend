...
/**
 * The base model interface for the DashboardWidget service. Represents a row in the &quot;adjecti_DashboardWidget&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.adjecti.dashboard.widget.model.impl.DashboardWidgetModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.adjecti.dashboard.widget.model.impl.DashboardWidgetImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface DashboardWidgetModel
	extends BaseModel<DashboardWidget>, GroupedModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a dashboard widget model instance should use the {@link DashboardWidget} interface instead.
	 */
