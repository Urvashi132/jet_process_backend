...
/**
 * Provides the local service interface for DashboardWidget. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DashboardWidgetLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DashboardWidgetLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adjecti.dashboard.widget.service.impl.DashboardWidgetLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dashboard widget local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DashboardWidgetLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DashboardWidget addDashboardWidget(
