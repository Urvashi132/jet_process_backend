...
/**
 * Provides the local service interface for Postal. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PostalLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PostalLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>io.jetprocess.service.impl.PostalLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the postal local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PostalLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Postal addPostal(Postal postal);

	public Postal addPostal(
		String postalMode, String postalCharge, String medium, String weight,
		long modeNo, String peonBookNo, String peonName, Date outDate,
		Date deliveryDate, String deliveryStatus);
	...
	public Postal createPostal(long id);
	...
	public Postal deletePostal(long id) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Postal deletePostal(Postal postal);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Postal fetchPostal(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Postal fetchPostalByUuidAndGroupId(String uuid, long groupId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Postal getPostal(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Postal getPostalByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Postal> getPostals(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Postal> getPostalsByUuidAndCompanyId(
