...
public class NoteLocalServiceUtil {
	 ...
	 * @return the new note
	 */
	public static Note createNote(long id) {
		return getService().createNote(id);
	}

	public static Note createNote(String content, long createdBy)
		throws PortalException {

		return getService().createNote(content, createdBy);
	}
	 ...
	 */
	public static Note deleteNote(long id) throws PortalException {
	...
	public static Note fetchNote(long id) {
		return getService().fetchNote(id);
	}
	 ...
	 * @throws PortalException if a note with the primary key could not be found
	 */
	public static Note getNote(long id) throws PortalException {
	...
	public static List<Note> getNotes() throws PortalException {
		return getService().getNotes();
	}
	...
	public static Note updateNote(long noteId, String content)
		throws PortalException {
