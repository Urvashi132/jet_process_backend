...
/**
 * Provides the local service interface for DraftRecipient. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DraftRecipientLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DraftRecipientLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>io.jetprocess.service.impl.DraftRecipientLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the draft recipient local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DraftRecipientLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DraftRecipient createDraftRecipient(long id);
	...
	public DraftRecipient deleteDraftRecipient(DraftRecipient draftRecipient);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public DraftRecipient deleteDraftRecipient(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DraftRecipient fetchDraftRecipient(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DraftRecipient fetchDraftRecipientByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DraftRecipient getDraftRecipient(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DraftRecipient getDraftRecipientByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DraftRecipient> getDraftRecipients(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DraftRecipient> getDraftRecipientsByUuidAndCompanyId(
