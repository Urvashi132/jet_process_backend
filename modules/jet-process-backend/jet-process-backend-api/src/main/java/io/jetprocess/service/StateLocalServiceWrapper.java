...
public class StateLocalServiceWrapper
	 ...
	 */
	@Override
	public io.jetprocess.model.State addState(io.jetprocess.model.State state) {
	 ...
	 */
	@Override
	public io.jetprocess.model.State createState(long id) {
		return _stateLocalService.createState(id);
	}
	 ...
	 */
	@Override
	public io.jetprocess.model.State deleteState(long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _stateLocalService.deleteState(id);
	}
	 ...
	 */
	@Override
	public io.jetprocess.model.State deleteState(
		io.jetprocess.model.State state) {
	...
	@Override
	public io.jetprocess.model.State fetchState(long id) {
		return _stateLocalService.fetchState(id);
	}
	 ...
	 */
	@Override
	public io.jetprocess.model.State getState(long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _stateLocalService.getState(id);
	}
	 ...
	 */
	@Override
	public java.util.List<io.jetprocess.model.State> getStates(
		int start, int end) {
	 ...
	 */
	@Override
	public io.jetprocess.model.State updateState(
		io.jetprocess.model.State state) {
