 ...
 * <code>io.jetprocess.service.impl.OrganizationLocalServiceImpl</code> and
...
public class OrganizationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>io.jetprocess.service.impl.OrganizationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Organization createOrganization(long id) {
		return getService().createOrganization(id);
	}
	 ...
	 */
	public static Organization deleteOrganization(long id)
		throws PortalException {
	...
	public static Organization fetchOrganization(long id) {
		return getService().fetchOrganization(id);
	}
	 ...
	 * @throws PortalException if a organization with the primary key could not be found
	 */
	public static Organization getOrganization(long id) throws PortalException {
