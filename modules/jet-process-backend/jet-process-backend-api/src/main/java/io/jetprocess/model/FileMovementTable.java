...
/**
 * The table class for the &quot;JP_FileMovement&quot; database table.
 *
...
public class FileMovementTable extends BaseTable<FileMovementTable> {
	...
	public final Column<FileMovementTable, Long> id = createColumn(
	...
	private FileMovementTable() {
		super("JP_FileMovement", FileMovementTable::new);
	}
