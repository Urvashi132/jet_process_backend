...
public class OrganizationUtil {
	...
	public static Organization findByUuid_First(
		...
		throws io.jetprocess.exception.NoSuchOrganizationException {
	 ...
	 * @throws NoSuchOrganizationException if a organization with the primary key could not be found
	 */
	public static Organization remove(long id)
		throws io.jetprocess.exception.NoSuchOrganizationException {
	 ...
	 * @throws NoSuchOrganizationException if a organization with the primary key could not be found
	 */
	public static Organization findByPrimaryKey(long id)
		throws io.jetprocess.exception.NoSuchOrganizationException {
	 ...
	 */
	public static Organization fetchByPrimaryKey(long id) {
