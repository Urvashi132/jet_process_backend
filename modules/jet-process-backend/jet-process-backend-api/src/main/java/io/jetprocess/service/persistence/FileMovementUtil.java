...
public class FileMovementUtil {
	 ...
	 */
	public static FileMovement create(long id) {
	 ...
	 * @throws NoSuchFileMovementException if a file movement with the primary key could not be found
	 */
	public static FileMovement remove(long id)
		throws io.jetprocess.exception.NoSuchFileMovementException {
	 ...
	 * @throws NoSuchFileMovementException if a file movement with the primary key could not be found
	 */
	public static FileMovement findByPrimaryKey(long id)
		throws io.jetprocess.exception.NoSuchFileMovementException {
	 ...
	 */
	public static FileMovement fetchByPrimaryKey(long id) {
