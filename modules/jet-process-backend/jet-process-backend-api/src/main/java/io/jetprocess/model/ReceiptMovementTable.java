...
/**
 * The table class for the &quot;JP_ReceiptMovement&quot; database table.
 *
...
public class ReceiptMovementTable extends BaseTable<ReceiptMovementTable> {
	...
	public final Column<ReceiptMovementTable, Long> id = createColumn(
	...
	public final Column<ReceiptMovementTable, String> remarks = createColumn(
	...
	private ReceiptMovementTable() {
		super("JP_ReceiptMovement", ReceiptMovementTable::new);
	}
