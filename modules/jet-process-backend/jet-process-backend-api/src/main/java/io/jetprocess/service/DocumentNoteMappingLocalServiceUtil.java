...
/**
 * Provides the local service utility for DocumentNoteMapping. This utility wraps
 * <code>io.jetprocess.service.impl.DocumentNoteMappingLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DocumentNoteMappingLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>io.jetprocess.service.impl.DocumentNoteMappingLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static DocumentNoteMapping addDocumentNoteMapping(
		...
		return getService().addDocumentNoteMapping(documentNoteMapping);
	}
	 ...
	 */
	public static DocumentNoteMapping createDocumentNoteMapping(long id) {
		return getService().createDocumentNoteMapping(id);
	}
	 ...
	 */
	public static DocumentNoteMapping deleteDocumentNoteMapping(
		DocumentNoteMapping documentNoteMapping) {

		return getService().deleteDocumentNoteMapping(documentNoteMapping);
	}
	 ...
	 */
	public static DocumentNoteMapping deleteDocumentNoteMapping(long id)
		throws PortalException {

		return getService().deleteDocumentNoteMapping(id);
	}

	public static void deleteDocumentNoteMappingById(long id)
		throws PortalException {

		getService().deleteDocumentNoteMappingById(id);
	}
	...
	public static DocumentNoteMapping fetchDocumentNoteMapping(long id) {
		return getService().fetchDocumentNoteMapping(id);
	}
	 ...
	 */
	public static DocumentNoteMapping fetchDocumentNoteMappingByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchDocumentNoteMappingByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a document note mapping with the primary key could not be found
	 */
	public static DocumentNoteMapping getDocumentNoteMapping(long id)
		throws PortalException {

		return getService().getDocumentNoteMapping(id);
	}
	 ...
	 */
	public static DocumentNoteMapping getDocumentNoteMappingByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getDocumentNoteMappingByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<DocumentNoteMapping> getDocumentNoteMappings(
		int start, int end) {

		return getService().getDocumentNoteMappings(start, end);
	}
	 ...
	 */
	public static List<DocumentNoteMapping>
		getDocumentNoteMappingsByUuidAndCompanyId(String uuid, long companyId) {

		return getService().getDocumentNoteMappingsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getDocumentNoteMappingsCount() {
		return getService().getDocumentNoteMappingsCount();
	}
	...
	public static DocumentNoteMapping updateDocumentNoteMapping(
		...
		return getService().updateDocumentNoteMapping(documentNoteMapping);
	}
	...
	public static DocumentNoteMappingLocalService getService() {
		return _service;
	}

	private static volatile DocumentNoteMappingLocalService _service;
