...
/**
 * The persistence interface for the subject category service.
 *
 * <p>
 ...
 * @see SubjectCategoryUtil
 * @generated
 */
@ProviderType
public interface SubjectCategoryPersistence
	extends BasePersistence<SubjectCategory> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SubjectCategoryUtil} to access the subject category persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<SubjectCategory> subjectCategories);
	 ...
	 */
	public java.util.List<SubjectCategory> findAll();
	 ...
	 */
	public java.util.List<SubjectCategory> findAll(int start, int end);
	...
	public java.util.List<SubjectCategory> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<SubjectCategory>
			orderByComparator);
