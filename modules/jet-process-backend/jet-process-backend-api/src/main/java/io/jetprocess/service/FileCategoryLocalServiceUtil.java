...
/**
 * Provides the local service utility for FileCategory. This utility wraps
 * <code>io.jetprocess.service.impl.FileCategoryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FileCategoryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>io.jetprocess.service.impl.FileCategoryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FileCategory addFileCategory(FileCategory fileCategory) {
		return getService().addFileCategory(fileCategory);
	}
	 ...
	 */
	public static FileCategory createFileCategory(long id) {
		return getService().createFileCategory(id);
	}
	 ...
	 */
	public static FileCategory deleteFileCategory(FileCategory fileCategory) {
		return getService().deleteFileCategory(fileCategory);
	}
	 ...
	 */
	public static FileCategory deleteFileCategory(long id)
		throws PortalException {

		return getService().deleteFileCategory(id);
	}
	...
	public static FileCategory fetchFileCategory(long id) {
		return getService().fetchFileCategory(id);
	}
	 ...
	 */
	public static List<FileCategory> getFileCategories(int start, int end) {
		return getService().getFileCategories(start, end);
	}
	 ...
	 */
	public static int getFileCategoriesCount() {
		return getService().getFileCategoriesCount();
	}
	 ...
	 * @throws PortalException if a file category with the primary key could not be found
	 */
	public static FileCategory getFileCategory(long id) throws PortalException {
		return getService().getFileCategory(id);
	}

	public static List<FileCategory> getFileCategoryList()
		throws PortalException {

		return getService().getFileCategoryList();
	}
	 ...
	 */
	public static FileCategory updateFileCategory(FileCategory fileCategory) {
		return getService().updateFileCategory(fileCategory);
	}

	public static FileCategoryLocalService getService() {
		return _service;
	}

	private static volatile FileCategoryLocalService _service;
