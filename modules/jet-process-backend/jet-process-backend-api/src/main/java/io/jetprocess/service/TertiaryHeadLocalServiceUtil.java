...
/**
 * Provides the local service utility for TertiaryHead. This utility wraps
 * <code>io.jetprocess.service.impl.TertiaryHeadLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TertiaryHeadLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>io.jetprocess.service.impl.TertiaryHeadLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TertiaryHead addTertiaryHead(TertiaryHead tertiaryHead) {
		return getService().addTertiaryHead(tertiaryHead);
	}
	 ...
	 * @return the tertiary head that was removed
	 */
	public static TertiaryHead deleteTertiaryHead(TertiaryHead tertiaryHead) {
		return getService().deleteTertiaryHead(tertiaryHead);
	}
	...
	public static List<TertiaryHead> getTeritaryHeadBySecondaryHeadId(
		long secondaryHeadId) {

		return getService().getTeritaryHeadBySecondaryHeadId(secondaryHeadId);
	}
	 ...
	 */
	public static int getTertiaryHeadsCount() {
		return getService().getTertiaryHeadsCount();
	}
	 ...
	 */
	public static TertiaryHead updateTertiaryHead(TertiaryHead tertiaryHead) {
		return getService().updateTertiaryHead(tertiaryHead);
	}

	public static TertiaryHeadLocalService getService() {
		return _service;
	}

	private static volatile TertiaryHeadLocalService _service;
