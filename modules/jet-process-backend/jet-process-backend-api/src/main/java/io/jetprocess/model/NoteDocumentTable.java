...
/**
 * The table class for the &quot;JP_NoteDocument&quot; database table.
 *
...
public class NoteDocumentTable extends BaseTable<NoteDocumentTable> {
	...
	public final Column<NoteDocumentTable, Long> id = createColumn(
	...
	public final Column<NoteDocumentTable, Long> currentUser = createColumn(
	...
	private NoteDocumentTable() {
		super("JP_NoteDocument", NoteDocumentTable::new);
	}
