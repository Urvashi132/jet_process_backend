...
/**
 * The extended model interface for the ReceiptMovement service. Represents a row in the &quot;JP_ReceiptMovement&quot; database table, with each column mapped to a property of this class.
 *
 * @author Brian Wing Shun Chan
 * @see ReceiptMovementModel
 * @generated
 */
@ImplementationClassName("io.jetprocess.model.impl.ReceiptMovementImpl")
@ProviderType
public interface ReceiptMovement extends PersistedModel, ReceiptMovementModel {
	...
	public static final Accessor<ReceiptMovement, Long> RM_ID_ACCESSOR =
		new Accessor<ReceiptMovement, Long>() {
			...
			@Override
			public Class<ReceiptMovement> getTypeClass() {
