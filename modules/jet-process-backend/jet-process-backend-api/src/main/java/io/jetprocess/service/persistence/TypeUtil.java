...
public class TypeUtil {
	...
	public static Type findByUuid_First(
		...
		throws io.jetprocess.exception.NoSuchTypeException {
	 ...
	 * @return the new type
	 */
	public static Type create(long id) {
	 ...
	 * @throws NoSuchTypeException if a type with the primary key could not be found
	 */
	public static Type remove(long id)
		throws io.jetprocess.exception.NoSuchTypeException {
	 ...
	 * @throws NoSuchTypeException if a type with the primary key could not be found
	 */
	public static Type findByPrimaryKey(long id)
		throws io.jetprocess.exception.NoSuchTypeException {
	 ...
	 */
	public static Type fetchByPrimaryKey(long id) {
