...
public class NoteDocumentLocalServiceWrapper
	 ...
	 */
	@Override
	public io.jetprocess.model.NoteDocument createNoteDocument(long id) {
		return _noteDocumentLocalService.createNoteDocument(id);
	}
	...
	public io.jetprocess.model.NoteDocument createNoteDocument(
		...
		return _noteDocumentLocalService.createNoteDocument(
	 ...
	 */
	@Override
	public io.jetprocess.model.NoteDocument deleteNoteDocument(long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _noteDocumentLocalService.deleteNoteDocument(id);
	}
	...
	@Override
	public io.jetprocess.model.NoteDocument fetchNoteDocument(long id) {
		return _noteDocumentLocalService.fetchNoteDocument(id);
	}
	...
	public String generateNoteDocumentNumber(long id) {
		return _noteDocumentLocalService.generateNoteDocumentNumber(id);
	}
	 ...
	 */
	@Override
	public io.jetprocess.model.NoteDocument getNoteDocument(long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _noteDocumentLocalService.getNoteDocument(id);
	}
	...
	public java.util.List<io.jetprocess.model.NoteDocument> getNoteDocuments()
		...
		return _noteDocumentLocalService.getNoteDocuments();
	}
