...
public class BasicHeadUtil {
	 ...
	 */
	public static List<BasicHead> findByUuid(String uuid) {
	 ...
	 */
	public static List<BasicHead> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<BasicHead> findByUuid(
	 ...
	 */
	public static BasicHead findByUuid_First(
	 ...
	 */
	public static BasicHead fetchByUuid_First(
		String uuid, OrderByComparator<BasicHead> orderByComparator) {
	 ...
	 * @throws NoSuchBasicHeadException if a matching basic head could not be found
	 */
	public static BasicHead findByUuid_Last(
			String uuid, OrderByComparator<BasicHead> orderByComparator)
		throws io.jetprocess.exception.NoSuchBasicHeadException {
	 ...
	 */
	public static BasicHead fetchByUuid_Last(
		String uuid, OrderByComparator<BasicHead> orderByComparator) {
	 ...
	 */
	public static BasicHead[] findByUuid_PrevAndNext(
			long basicHeadId, String uuid,
			OrderByComparator<BasicHead> orderByComparator)
		throws io.jetprocess.exception.NoSuchBasicHeadException {

		return getPersistence().findByUuid_PrevAndNext(
			basicHeadId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchBasicHeadException if a matching basic head could not be found
	 */
	public static BasicHead findByUUID_G(String uuid, long groupId)
		throws io.jetprocess.exception.NoSuchBasicHeadException {
	 ...
	 */
	public static BasicHead fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching basic head, or <code>null</code> if a matching basic head could not be found
	 */
	public static BasicHead fetchByUUID_G(
	 ...
	 */
	public static BasicHead removeByUUID_G(String uuid, long groupId)
		throws io.jetprocess.exception.NoSuchBasicHeadException {
	 ...
	 * @return the matching basic heads
	 */
	public static List<BasicHead> findByUuid_C(String uuid, long companyId) {
	 ...
	 * @return the range of matching basic heads
	 */
	public static List<BasicHead> findByUuid_C(
	 ...
	 * @throws NoSuchBasicHeadException if a matching basic head could not be found
	 */
	public static BasicHead findByUuid_C_First(
	 ...
	 * @return the first matching basic head, or <code>null</code> if a matching basic head could not be found
	 */
	public static BasicHead fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<BasicHead> orderByComparator) {
	 ...
	 * @throws NoSuchBasicHeadException if a matching basic head could not be found
	 */
	public static BasicHead findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<BasicHead> orderByComparator)
		throws io.jetprocess.exception.NoSuchBasicHeadException {
	 ...
	 * @return the last matching basic head, or <code>null</code> if a matching basic head could not be found
	 */
	public static BasicHead fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<BasicHead> orderByComparator) {
	 ...
	 * @throws NoSuchBasicHeadException if a basic head with the primary key could not be found
	 */
	public static BasicHead[] findByUuid_C_PrevAndNext(
			long basicHeadId, String uuid, long companyId,
			OrderByComparator<BasicHead> orderByComparator)
		throws io.jetprocess.exception.NoSuchBasicHeadException {

		return getPersistence().findByUuid_C_PrevAndNext(
			basicHeadId, uuid, companyId, orderByComparator);
	}
