 ...
 * <code>io.jetprocess.service.impl.TypeLocalServiceImpl</code> and
...
public class TypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>io.jetprocess.service.impl.TypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 * @return the new type
	 */
	public static Type createType(long id) {
		return getService().createType(id);
	}
	 ...
	 */
	public static Type deleteType(long id) throws PortalException {
		return getService().deleteType(id);
	}
	...
	public static Type fetchType(long id) {
		return getService().fetchType(id);
	}
	 ...
	 * @throws PortalException if a type with the primary key could not be found
	 */
	public static Type getType(long id) throws PortalException {
