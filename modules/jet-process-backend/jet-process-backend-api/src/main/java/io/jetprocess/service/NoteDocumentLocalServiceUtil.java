...
public class NoteDocumentLocalServiceUtil {
	 ...
	 */
	public static NoteDocument createNoteDocument(long id) {
		return getService().createNoteDocument(id);
	}

	public static NoteDocument createNoteDocument(
			String subject, long subjectCategoryId, long createdBy)
		throws PortalException {

		return getService().createNoteDocument(
			subject, subjectCategoryId, createdBy);
	}
	 ...
	 */
	public static NoteDocument deleteNoteDocument(long id)
		throws PortalException {

		return getService().deleteNoteDocument(id);
	}
	...
	public static NoteDocument fetchNoteDocument(long id) {
		return getService().fetchNoteDocument(id);
	}
	...
	public static String generateNoteDocumentNumber(long id) {
		return getService().generateNoteDocumentNumber(id);
	}
	 ...
	 * @throws PortalException if a note document with the primary key could not be found
	 */
	public static NoteDocument getNoteDocument(long id) throws PortalException {
		return getService().getNoteDocument(id);
	}
	...
	public static List<NoteDocument> getNoteDocuments() throws PortalException {
		return getService().getNoteDocuments();
	}
	...
	public static NoteDocument updateNoteDocument(
			long id, String subject, long subjectCategoryId)
		throws PortalException {

		return getService().updateNoteDocument(id, subject, subjectCategoryId);
	}
