...
/**
 * The extended model interface for the NoteDocument service. Represents a row in the &quot;JP_NoteDocument&quot; database table, with each column mapped to a property of this class.
 *
...
public interface NoteDocument extends NoteDocumentModel, PersistedModel {
	 ...
	 */
	public static final Accessor<NoteDocument, Long> ID_ACCESSOR =
		new Accessor<NoteDocument, Long>() {

			@Override
			public Long get(NoteDocument noteDocument) {
				return noteDocument.getId();
			}
