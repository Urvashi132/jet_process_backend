...
public class FileMovementLocalServiceWrapper
	 ...
	 */
	@Override
	public io.jetprocess.model.FileMovement createFileMovement(long id) {
		return _fileMovementLocalService.createFileMovement(id);
	}
	 ...
	 */
	@Override
	public io.jetprocess.model.FileMovement deleteFileMovement(long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _fileMovementLocalService.deleteFileMovement(id);
	}
	...
	@Override
	public io.jetprocess.model.FileMovement fetchFileMovement(long id) {
		return _fileMovementLocalService.fetchFileMovement(id);
	}
	 ...
	 */
	@Override
	public io.jetprocess.model.FileMovement getFileMovement(long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _fileMovementLocalService.getFileMovement(id);
	}
