...
public class FileMovementLocalServiceUtil {
	 ...
	 */
	public static FileMovement createFileMovement(long id) {
		return getService().createFileMovement(id);
	}
	 ...
	 */
	public static FileMovement deleteFileMovement(long id)
		throws PortalException {

		return getService().deleteFileMovement(id);
	}
	...
	public static FileMovement fetchFileMovement(long id) {
		return getService().fetchFileMovement(id);
	}
	...
	public static FileMovement getFileMovement() {
		return getService().getFileMovement();
	}
	 ...
	 * @throws PortalException if a file movement with the primary key could not be found
	 */
	public static FileMovement getFileMovement(long id) throws PortalException {
		return getService().getFileMovement(id);
	}
