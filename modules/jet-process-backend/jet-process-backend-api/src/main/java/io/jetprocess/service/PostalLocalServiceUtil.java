...
/**
 * Provides the local service utility for Postal. This utility wraps
 * <code>io.jetprocess.service.impl.PostalLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PostalLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>io.jetprocess.service.impl.PostalLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Postal addPostal(Postal postal) {
		return getService().addPostal(postal);
	}

	public static Postal addPostal(
	 ...
	 */
	public static Postal createPostal(long id) {
		return getService().createPostal(id);
	}
	 ...
	 */
	public static Postal deletePostal(long id) throws PortalException {
		return getService().deletePostal(id);
	}
	 ...
	 * @return the postal that was removed
	 */
	public static Postal deletePostal(Postal postal) {
		return getService().deletePostal(postal);
	}

	public static void deletePostalById(long postalId) throws PortalException {
		getService().deletePostalById(postalId);
	}
	...
	public static Postal fetchPostal(long id) {
		return getService().fetchPostal(id);
	}
	 ...
	 */
	public static Postal fetchPostalByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchPostalByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 * @throws PortalException if a postal with the primary key could not be found
	 */
	public static Postal getPostal(long id) throws PortalException {
		return getService().getPostal(id);
	}

	public static Postal getPostalById(long postalId) {
		return getService().getPostalById(postalId);
	}
	 ...
	 */
	public static Postal getPostalByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {

		return getService().getPostalByUuidAndGroupId(uuid, groupId);
	}

	public static List<Postal> getPostalList() {
		return getService().getPostalList();
	}
	 ...
	 */
	public static List<Postal> getPostals(int start, int end) {
		return getService().getPostals(start, end);
	}
	 ...
	 */
	public static List<Postal> getPostalsByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getPostalsByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<Postal> getPostalsByUuidAndCompanyId(
		...
		return getService().getPostalsByUuidAndCompanyId(
	 ...
	 */
	public static int getPostalsCount() {
		return getService().getPostalsCount();
	}
	 ...
	 */
	public static Postal updatePostal(Postal postal) {
		return getService().updatePostal(postal);
	}

	public static PostalLocalService getService() {
		return _service;
	}

	private static volatile PostalLocalService _service;
