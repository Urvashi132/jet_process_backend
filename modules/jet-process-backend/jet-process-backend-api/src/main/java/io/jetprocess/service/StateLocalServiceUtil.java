 ...
 * <code>io.jetprocess.service.impl.StateLocalServiceImpl</code> and
...
public class StateLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>io.jetprocess.service.impl.StateLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static State createState(long id) {
		return getService().createState(id);
	}
	 ...
	 */
	public static State deleteState(long id) throws PortalException {
		return getService().deleteState(id);
	}
	...
	public static State fetchState(long id) {
		return getService().fetchState(id);
	}
	 ...
	 * @throws PortalException if a state with the primary key could not be found
	 */
	public static State getState(long id) throws PortalException {
		return getService().getState(id);
	}
