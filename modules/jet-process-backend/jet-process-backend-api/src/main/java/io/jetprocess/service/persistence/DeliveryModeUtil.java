...
public class DeliveryModeUtil {
	 ...
	 */
	public static List<DeliveryMode> findByUuid(String uuid) {
	 ...
	 */
	public static List<DeliveryMode> findByUuid(
	 ...
	 */
	public static DeliveryMode findByUuid_First(
	 ...
	 */
	public static DeliveryMode fetchByUuid_First(
		String uuid, OrderByComparator<DeliveryMode> orderByComparator) {
	 ...
	 * @throws NoSuchDeliveryModeException if a matching delivery mode could not be found
	 */
	public static DeliveryMode findByUuid_Last(
			String uuid, OrderByComparator<DeliveryMode> orderByComparator)
		throws io.jetprocess.exception.NoSuchDeliveryModeException {
	 ...
	 */
	public static DeliveryMode fetchByUuid_Last(
		String uuid, OrderByComparator<DeliveryMode> orderByComparator) {
	 ...
	 */
	public static DeliveryMode[] findByUuid_PrevAndNext(
			long id, String uuid,
			OrderByComparator<DeliveryMode> orderByComparator)
		throws io.jetprocess.exception.NoSuchDeliveryModeException {
