...
public class FileMovementPersistenceImpl
	 ...
	 *
	 * @param id the primary key of the current file movement
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public FileMovement[] findByUuid_PrevAndNext(
		...
		FileMovement fileMovement = findByPrimaryKey(id);
	 ...
	 */
	@Override
	public FileMovement remove(long id) throws NoSuchFileMovementException {
	 ...
	 */
	@Override
	public FileMovement findByPrimaryKey(long id)
		throws NoSuchFileMovementException {
	 ...
	 */
	@Override
	public FileMovement fetchByPrimaryKey(long id) {
