...
import io.jetprocess.service.NoteDocumentService;
import io.jetprocess.service.NoteDocumentServiceUtil;
...
/**
 * Provides the base implementation for the note document remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.NoteDocumentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.NoteDocumentServiceImpl
 * @generated
 */
public abstract class NoteDocumentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, NoteDocumentService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NoteDocumentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>NoteDocumentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NoteDocumentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		noteDocumentService = (NoteDocumentService)aopProxy;

		_setServiceUtilService(noteDocumentService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return NoteDocumentService.class.getName();
	}
	...
	private void _setServiceUtilService(
		NoteDocumentService noteDocumentService) {

		try {
			Field field = NoteDocumentServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, noteDocumentService);
		}
	...
	@Reference
	protected io.jetprocess.service.NoteDocumentLocalService
		noteDocumentLocalService;

	protected NoteDocumentService noteDocumentService;
