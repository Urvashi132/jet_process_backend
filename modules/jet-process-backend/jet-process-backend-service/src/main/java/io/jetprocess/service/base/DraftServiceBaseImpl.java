...
import io.jetprocess.service.DraftService;
import io.jetprocess.service.DraftServiceUtil;
...
/**
 * Provides the base implementation for the draft remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.DraftServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.DraftServiceImpl
 * @generated
 */
public abstract class DraftServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DraftService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DraftService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DraftServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DraftService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		draftService = (DraftService)aopProxy;

		_setServiceUtilService(draftService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DraftService.class.getName();
	}
	...
	private void _setServiceUtilService(DraftService draftService) {
		try {
			Field field = DraftServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, draftService);
		}
	...
	@Reference
	protected io.jetprocess.service.DraftLocalService draftLocalService;
