...
import io.jetprocess.service.SubjectCategoryService;
import io.jetprocess.service.SubjectCategoryServiceUtil;
...
/**
 * Provides the base implementation for the subject category remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.SubjectCategoryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.SubjectCategoryServiceImpl
 * @generated
 */
public abstract class SubjectCategoryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SubjectCategoryService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SubjectCategoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SubjectCategoryServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SubjectCategoryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		subjectCategoryService = (SubjectCategoryService)aopProxy;

		_setServiceUtilService(subjectCategoryService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SubjectCategoryService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = SubjectCategoryServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, subjectCategoryService);
		}
	...
	@Reference
	protected io.jetprocess.service.SubjectCategoryLocalService
