...
/**
 * Provides the base implementation for the doc file remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.DocFileServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.DocFileServiceImpl
 * @generated
 */
public abstract class DocFileServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DocFileService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DocFileService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DocFileServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DocFileService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		docFileService = (DocFileService)aopProxy;

		_setServiceUtilService(docFileService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DocFileService.class.getName();
	}
	...
	private void _setServiceUtilService(DocFileService docFileService) {
		try {
			Field field = DocFileServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, docFileService);
		}
