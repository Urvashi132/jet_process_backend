...
import io.jetprocess.service.DeliveryModeService;
import io.jetprocess.service.DeliveryModeServiceUtil;
...
/**
 * Provides the base implementation for the delivery mode remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.DeliveryModeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.DeliveryModeServiceImpl
 * @generated
 */
public abstract class DeliveryModeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DeliveryModeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DeliveryModeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DeliveryModeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DeliveryModeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		deliveryModeService = (DeliveryModeService)aopProxy;

		_setServiceUtilService(deliveryModeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DeliveryModeService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DeliveryModeServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, deliveryModeService);
		}
	...
	@Reference
	protected io.jetprocess.service.DeliveryModeLocalService
