...
import io.jetprocess.service.PostalLocalService;
import io.jetprocess.service.PostalLocalServiceUtil;
...
/**
 * Provides the base implementation for the postal local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.PostalLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.PostalLocalServiceImpl
 * @generated
 */
public abstract class PostalLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PostalLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PostalLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PostalLocalServiceUtil</code>.
	 */
	...
	public Postal addPostal(Postal postal) {
		...
		return postalPersistence.update(postal);
	}
	...
	public Postal createPostal(long id) {
		return postalPersistence.create(id);
	}
	...
	public Postal deletePostal(long id) throws PortalException {
		return postalPersistence.remove(id);
	}
	...
	public Postal deletePostal(Postal postal) {
		return postalPersistence.remove(postal);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return postalPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Postal.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return postalPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return postalPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return postalPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return postalPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return postalPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Postal fetchPostal(long id) {
		return postalPersistence.fetchByPrimaryKey(id);
	}
	...
	public Postal fetchPostalByUuidAndGroupId(String uuid, long groupId) {
		return postalPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Postal getPostal(long id) throws PortalException {
		return postalPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(postalLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Postal.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(postalLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Postal.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Postal>() {

				@Override
				public void performAction(Postal postal)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, postal);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return postalPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return postalLocalService.deletePostal((Postal)persistedModel);
	}

	@Override
	public BasePersistence<Postal> getBasePersistence() {
		return postalPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return postalPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Postal> getPostalsByUuidAndCompanyId(
		...
		return postalPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Postal> getPostalsByUuidAndCompanyId(
		...
		return postalPersistence.findByUuid_C(
	...
	public Postal getPostalByUuidAndGroupId(String uuid, long groupId)
		...
		return postalPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Postal> getPostals(int start, int end) {
		return postalPersistence.findAll(start, end);
	}
	...
	public int getPostalsCount() {
		return postalPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PostalLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		postalLocalService = (PostalLocalService)aopProxy;

		_setLocalServiceUtilService(postalLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PostalLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		PostalLocalService postalLocalService) {

		try {
			Field field = PostalLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, postalLocalService);
		}
	...
	protected PostalLocalService postalLocalService;
