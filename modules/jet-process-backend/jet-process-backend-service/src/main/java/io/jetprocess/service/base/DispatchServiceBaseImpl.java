...
import io.jetprocess.service.DispatchService;
import io.jetprocess.service.DispatchServiceUtil;
...
/**
 * Provides the base implementation for the dispatch remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.DispatchServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.DispatchServiceImpl
 * @generated
 */
public abstract class DispatchServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DispatchService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DispatchService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DispatchServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DispatchService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dispatchService = (DispatchService)aopProxy;

		_setServiceUtilService(dispatchService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DispatchService.class.getName();
	}
	...
	private void _setServiceUtilService(DispatchService dispatchService) {
		try {
			Field field = DispatchServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dispatchService);
		}
	...
	@Reference
	protected io.jetprocess.service.DispatchLocalService dispatchLocalService;
