...
import io.jetprocess.service.DraftRecipientService;
import io.jetprocess.service.DraftRecipientServiceUtil;
...
/**
 * Provides the base implementation for the draft recipient remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.DraftRecipientServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.DraftRecipientServiceImpl
 * @generated
 */
public abstract class DraftRecipientServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DraftRecipientService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DraftRecipientService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DraftRecipientServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DraftRecipientService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		draftRecipientService = (DraftRecipientService)aopProxy;

		_setServiceUtilService(draftRecipientService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DraftRecipientService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DraftRecipientServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, draftRecipientService);
		}
	...
	@Reference
	protected io.jetprocess.service.DraftRecipientLocalService
		draftRecipientLocalService;

	protected DraftRecipientService draftRecipientService;
