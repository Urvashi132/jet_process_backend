...
/**
 * Provides the base implementation for the primary head remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.PrimaryHeadServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.PrimaryHeadServiceImpl
 * @generated
 */
public abstract class PrimaryHeadServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PrimaryHeadService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PrimaryHeadService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PrimaryHeadServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PrimaryHeadService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		primaryHeadService = (PrimaryHeadService)aopProxy;

		_setServiceUtilService(primaryHeadService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PrimaryHeadService.class.getName();
	}
	...
	private void _setServiceUtilService(PrimaryHeadService primaryHeadService) {
		try {
			Field field = PrimaryHeadServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, primaryHeadService);
		}
	...
	protected PrimaryHeadService primaryHeadService;
