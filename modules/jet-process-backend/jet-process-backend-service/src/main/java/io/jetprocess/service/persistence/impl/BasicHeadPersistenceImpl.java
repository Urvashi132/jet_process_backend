...
public class BasicHeadPersistenceImpl
	 ...
	 */
	@Override
	public List<BasicHead> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<BasicHead> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<BasicHead> findByUuid(
	...
	public List<BasicHead> findByUuid(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (BasicHead basicHead : list) {
					if (!uuid.equals(basicHead.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_BASICHEAD_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(BasicHeadModelImpl.ORDER_BY_JPQL);
			}
	...
	public BasicHead findByUuid_First(
			String uuid, OrderByComparator<BasicHead> orderByComparator)
		throws NoSuchBasicHeadException {

		BasicHead basicHead = fetchByUuid_First(uuid, orderByComparator);
		...
		throw new NoSuchBasicHeadException(sb.toString());
	}
	...
	public BasicHead fetchByUuid_First(
		...
		List<BasicHead> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public BasicHead findByUuid_Last(
		...
		BasicHead basicHead = fetchByUuid_Last(uuid, orderByComparator);
	...
	public BasicHead fetchByUuid_Last(
		...
		List<BasicHead> list = findByUuid(
	...
	public BasicHead[] findByUuid_PrevAndNext(
		...
		BasicHead basicHead = findByPrimaryKey(basicHeadId);
		...
		try {
			...
			BasicHead[] array = new BasicHeadImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, basicHead, uuid, orderByComparator, true);

			array[1] = basicHead;

			array[2] = getByUuid_PrevAndNext(
				session, basicHead, uuid, orderByComparator, false);
	...
	protected BasicHead getByUuid_PrevAndNext(
		Session session, BasicHead basicHead, String uuid,
		OrderByComparator<BasicHead> orderByComparator, boolean previous) {
		...
		if (orderByComparator != null) {
			for (Object orderByConditionValue :
					orderByComparator.getOrderByConditionValues(basicHead)) {

				queryPos.add(orderByConditionValue);
			}
		}

		List<BasicHead> list = query.list();
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_BASICHEAD_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(basicHead.uuid IS NULL OR basicHead.uuid = '')";
	...
	public BasicHead findByUUID_G(String uuid, long groupId)
		...
		BasicHead basicHead = fetchByUUID_G(uuid, groupId);
	...
	public BasicHead fetchByUUID_G(
		...
		if (result instanceof BasicHead) {
			BasicHead basicHead = (BasicHead)result;

			if (!Objects.equals(uuid, basicHead.getUuid()) ||
				(groupId != basicHead.getGroupId())) {
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					BasicHead basicHead = list.get(0);
	...
	public BasicHead removeByUUID_G(String uuid, long groupId)
		...
		BasicHead basicHead = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(basicHead.uuid IS NULL OR basicHead.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<BasicHead> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<BasicHead> findByUuid_C(
	...
	public List<BasicHead> findByUuid_C(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (BasicHead basicHead : list) {
					if (!uuid.equals(basicHead.getUuid()) ||
						(companyId != basicHead.getCompanyId())) {
	...
	public BasicHead findByUuid_C_First(
		...
		BasicHead basicHead = fetchByUuid_C_First(
	...
	public BasicHead fetchByUuid_C_First(
		...
		List<BasicHead> list = findByUuid_C(
	...
	public BasicHead findByUuid_C_Last(
		...
		BasicHead basicHead = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public BasicHead[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, basicHead, uuid, companyId, orderByComparator, true);

			array[1] = basicHead;

			array[2] = getByUuid_C_PrevAndNext(
				session, basicHead, uuid, companyId, orderByComparator, false);
	...
	protected BasicHead getByUuid_C_PrevAndNext(
		Session session, BasicHead basicHead, String uuid, long companyId,
		OrderByComparator<BasicHead> orderByComparator, boolean previous) {
	...
	public void cacheResult(BasicHead basicHead) {
		...
		finderCache.putResult(
			...
			new Object[] {basicHead.getUuid(), basicHead.getGroupId()},
			basicHead);
	}
	...
	protected void cacheUniqueFindersCache(
		BasicHeadModelImpl basicHeadModelImpl) {

		Object[] args = new Object[] {
			basicHeadModelImpl.getUuid(), basicHeadModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, basicHeadModelImpl);
	}
	...
	public BasicHead create(long basicHeadId) {
		...
		basicHead.setUuid(uuid);

		basicHead.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public BasicHead updateImpl(BasicHead basicHead) {
		...
		if (!(basicHead instanceof BasicHeadModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(basicHead.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(basicHead);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in basicHead proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom BasicHead implementation " +
					basicHead.getClass());
		}

		BasicHeadModelImpl basicHeadModelImpl = (BasicHeadModelImpl)basicHead;

		if (Validator.isNull(basicHead.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (basicHead.getCreateDate() == null)) {
			if (serviceContext == null) {
				basicHead.setCreateDate(date);
			}
			else {
				basicHead.setCreateDate(serviceContext.getCreateDate(date));
			}
		}

		if (!basicHeadModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				basicHead.setModifiedDate(date);
			}
			else {
				basicHead.setModifiedDate(serviceContext.getModifiedDate(date));
			}
		}
		...
		entityCache.putResult(
			BasicHeadImpl.class, basicHeadModelImpl, false, true);

		cacheUniqueFindersCache(basicHeadModelImpl);
	...
	private static final String _SQL_SELECT_BASICHEAD_WHERE =
		"SELECT basicHead FROM BasicHead basicHead WHERE ";

	private static final String _SQL_COUNT_BASICHEAD =
		"SELECT COUNT(basicHead) FROM BasicHead basicHead";

	private static final String _SQL_COUNT_BASICHEAD_WHERE =
		"SELECT COUNT(basicHead) FROM BasicHead basicHead WHERE ";
	...
	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No BasicHead exists with the key {";
