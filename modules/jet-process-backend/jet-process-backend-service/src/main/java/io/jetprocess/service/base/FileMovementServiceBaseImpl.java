...
import io.jetprocess.service.FileMovementService;
import io.jetprocess.service.FileMovementServiceUtil;
...
/**
 * Provides the base implementation for the file movement remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.FileMovementServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.FileMovementServiceImpl
 * @generated
 */
public abstract class FileMovementServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FileMovementService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FileMovementService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FileMovementServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FileMovementService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		fileMovementService = (FileMovementService)aopProxy;

		_setServiceUtilService(fileMovementService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FileMovementService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = FileMovementServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, fileMovementService);
		}
	...
	@Reference
	protected io.jetprocess.service.FileMovementLocalService
		fileMovementLocalService;

	protected FileMovementService fileMovementService;
