...
public abstract class NoteDocumentLocalServiceBaseImpl
	...
	public NoteDocument createNoteDocument(long id) {
		return noteDocumentPersistence.create(id);
	}
	...
	public NoteDocument deleteNoteDocument(long id) throws PortalException {
		return noteDocumentPersistence.remove(id);
	}
	...
	public NoteDocument fetchNoteDocument(long id) {
		return noteDocumentPersistence.fetchByPrimaryKey(id);
	}
	...
	public NoteDocument getNoteDocument(long id) throws PortalException {
		return noteDocumentPersistence.findByPrimaryKey(id);
	}
