...
import io.jetprocess.service.TertiaryHeadServiceUtil;
...
/**
 * Provides the base implementation for the tertiary head remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.TertiaryHeadServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.TertiaryHeadServiceImpl
 * @generated
 */
public abstract class TertiaryHeadServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TertiaryHeadService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TertiaryHeadService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TertiaryHeadServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TertiaryHeadService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		tertiaryHeadService = (TertiaryHeadService)aopProxy;

		_setServiceUtilService(tertiaryHeadService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TertiaryHeadService.class.getName();
	}
	...
	private void _setServiceUtilService(
		TertiaryHeadService tertiaryHeadService) {

		try {
			Field field = TertiaryHeadServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, tertiaryHeadService);
		}
	...
	@Reference
	protected io.jetprocess.service.TertiaryHeadLocalService
		tertiaryHeadLocalService;

	protected TertiaryHeadService tertiaryHeadService;
