...
import io.jetprocess.service.FileCategoryService;
import io.jetprocess.service.FileCategoryServiceUtil;
...
/**
 * Provides the base implementation for the file category remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.FileCategoryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.FileCategoryServiceImpl
 * @generated
 */
public abstract class FileCategoryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FileCategoryService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FileCategoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FileCategoryServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FileCategoryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		fileCategoryService = (FileCategoryService)aopProxy;

		_setServiceUtilService(fileCategoryService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FileCategoryService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = FileCategoryServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, fileCategoryService);
		}
	...
	@Reference
	protected io.jetprocess.service.FileCategoryLocalService
