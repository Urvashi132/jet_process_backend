...
import io.jetprocess.model.TypeTable;
import io.jetprocess.model.impl.TypeImpl;
import io.jetprocess.model.impl.TypeModelImpl;
import io.jetprocess.service.persistence.TypePersistence;
import io.jetprocess.service.persistence.TypeUtil;
 ...
 * @generated
 */
@Component(service = {TypePersistence.class, BasePersistence.class})
public class TypePersistenceImpl
	...
	public Type[] findByUuid_PrevAndNext(
			long id, String uuid, OrderByComparator<Type> orderByComparator)
		throws NoSuchTypeException {

		uuid = Objects.toString(uuid, "");

		Type type = findByPrimaryKey(id);
	...
	public Type updateImpl(Type type) {
		...
		entityCache.putResult(TypeImpl.class, typeModelImpl, false, true);
	...
	@Reference
	private TypeModelArgumentsResolver _typeModelArgumentsResolver;
