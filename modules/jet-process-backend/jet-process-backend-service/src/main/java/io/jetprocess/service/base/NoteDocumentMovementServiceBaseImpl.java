...
import io.jetprocess.service.NoteDocumentMovementService;
import io.jetprocess.service.NoteDocumentMovementServiceUtil;
...
/**
 * Provides the base implementation for the note document movement remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.NoteDocumentMovementServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.NoteDocumentMovementServiceImpl
 * @generated
 */
public abstract class NoteDocumentMovementServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   NoteDocumentMovementService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NoteDocumentMovementService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>NoteDocumentMovementServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NoteDocumentMovementService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		noteDocumentMovementService = (NoteDocumentMovementService)aopProxy;

		_setServiceUtilService(noteDocumentMovementService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return NoteDocumentMovementService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				NoteDocumentMovementServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, noteDocumentMovementService);
		}
	...
	@Reference
	protected io.jetprocess.service.NoteDocumentMovementLocalService
		noteDocumentMovementLocalService;

	protected NoteDocumentMovementService noteDocumentMovementService;
