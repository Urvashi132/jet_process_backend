...
/**
 * Provides the base implementation for the draft recipient local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.DraftRecipientLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.DraftRecipientLocalServiceImpl
 * @generated
 */
public abstract class DraftRecipientLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DraftRecipientLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DraftRecipientLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DraftRecipientLocalServiceUtil</code>.
	 */
	...
	public DraftRecipient addDraftRecipient(DraftRecipient draftRecipient) {
		...
		return draftRecipientPersistence.update(draftRecipient);
	}
	...
	public DraftRecipient createDraftRecipient(long id) {
		return draftRecipientPersistence.create(id);
	}
	...
	public DraftRecipient deleteDraftRecipient(long id) throws PortalException {
		return draftRecipientPersistence.remove(id);
	}
	...
	public DraftRecipient deleteDraftRecipient(DraftRecipient draftRecipient) {
		return draftRecipientPersistence.remove(draftRecipient);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return draftRecipientPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DraftRecipient.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return draftRecipientPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return draftRecipientPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return draftRecipientPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return draftRecipientPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DraftRecipient fetchDraftRecipient(long id) {
		return draftRecipientPersistence.fetchByPrimaryKey(id);
	}
	...
	public DraftRecipient fetchDraftRecipientByUuidAndGroupId(
		...
		return draftRecipientPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DraftRecipient getDraftRecipient(long id) throws PortalException {
		return draftRecipientPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(draftRecipientLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DraftRecipient.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			draftRecipientLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DraftRecipient.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<DraftRecipient>() {

				@Override
				public void performAction(DraftRecipient draftRecipient)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, draftRecipient);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return draftRecipientPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return draftRecipientLocalService.deleteDraftRecipient(
			(DraftRecipient)persistedModel);
	}

	@Override
	public BasePersistence<DraftRecipient> getBasePersistence() {
		return draftRecipientPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return draftRecipientPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DraftRecipient> getDraftRecipientsByUuidAndCompanyId(
		...
		return draftRecipientPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DraftRecipient> getDraftRecipientsByUuidAndCompanyId(
		...
		return draftRecipientPersistence.findByUuid_C(
	...
	public DraftRecipient getDraftRecipientByUuidAndGroupId(
		...
		return draftRecipientPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<DraftRecipient> getDraftRecipients(int start, int end) {
		return draftRecipientPersistence.findAll(start, end);
	}
	...
	public int getDraftRecipientsCount() {
		return draftRecipientPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DraftRecipientLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		draftRecipientLocalService = (DraftRecipientLocalService)aopProxy;

		_setLocalServiceUtilService(draftRecipientLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DraftRecipientLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = draftRecipientPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = DraftRecipientLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, draftRecipientLocalService);
		}
	...
	protected DraftRecipientLocalService draftRecipientLocalService;
