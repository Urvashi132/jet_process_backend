...
import io.jetprocess.service.NoteService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.NoteServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.NoteServiceImpl
 * @generated
 */
public abstract class NoteServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NoteService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>NoteServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setServiceUtilService(noteService);
	}
	...
	private void _setServiceUtilService(NoteService noteService) {
		try {
			Field field = NoteServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, noteService);
		}
	...
	@Reference
	protected io.jetprocess.service.NoteLocalService noteLocalService;
