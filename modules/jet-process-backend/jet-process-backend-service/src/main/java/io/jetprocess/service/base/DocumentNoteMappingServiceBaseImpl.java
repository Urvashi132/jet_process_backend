...
import io.jetprocess.service.DocumentNoteMappingService;
...
/**
 * Provides the base implementation for the document note mapping remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link io.jetprocess.service.impl.DocumentNoteMappingServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see io.jetprocess.service.impl.DocumentNoteMappingServiceImpl
 * @generated
 */
public abstract class DocumentNoteMappingServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DocumentNoteMappingService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DocumentNoteMappingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DocumentNoteMappingServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DocumentNoteMappingService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		documentNoteMappingService = (DocumentNoteMappingService)aopProxy;

		_setServiceUtilService(documentNoteMappingService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DocumentNoteMappingService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DocumentNoteMappingServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, documentNoteMappingService);
		}
	...
	@Reference
	protected io.jetprocess.service.DocumentNoteMappingLocalService
		documentNoteMappingLocalService;

	protected DocumentNoteMappingService documentNoteMappingService;
