 ...
 */
@Generated("")
@GraphQLName("SecondaryHeadRsModel")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "SecondaryHeadRsModel")
public class SecondaryHeadRsModel implements Serializable {

	public static SecondaryHeadRsModel toDTO(String json) {
		return ObjectMapperUtil.readValue(SecondaryHeadRsModel.class, json);
	}

	public static SecondaryHeadRsModel unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			SecondaryHeadRsModel.class, json);
	}
	...
	public String getSecondaryHeadValue() {
		return secondaryHeadValue;
	}

	public void setSecondaryHeadValue(String secondaryHeadValue) {
		this.secondaryHeadValue = secondaryHeadValue;
	}

	@JsonIgnore
	public void setSecondaryHeadValue(
		UnsafeSupplier<String, Exception> secondaryHeadValueUnsafeSupplier) {

		try {
			secondaryHeadValue = secondaryHeadValueUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String secondaryHeadValue;
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof SecondaryHeadRsModel)) {
			return false;
		}

		SecondaryHeadRsModel secondaryHeadRsModel =
			(SecondaryHeadRsModel)object;

		return Objects.equals(toString(), secondaryHeadRsModel.toString());
	}
	...
	public String toString() {
		...
		if (secondaryHeadValue != null) {
			...
			sb.append(_escape(secondaryHeadValue));
	...
	@Schema(
		...
		defaultValue = "io.jetprocess.dto.v1_0.SecondaryHeadRsModel",
		name = "x-class-name"
	)
