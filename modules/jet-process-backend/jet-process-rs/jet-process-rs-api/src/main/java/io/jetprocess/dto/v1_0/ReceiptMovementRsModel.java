 ...
 */
@Generated("")
@GraphQLName("ReceiptMovementRsModel")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ReceiptMovementRsModel")
public class ReceiptMovementRsModel implements Serializable {

	public static ReceiptMovementRsModel toDTO(String json) {
		return ObjectMapperUtil.readValue(ReceiptMovementRsModel.class, json);
	}

	public static ReceiptMovementRsModel unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			ReceiptMovementRsModel.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof ReceiptMovementRsModel)) {
			return false;
		}

		ReceiptMovementRsModel receiptMovementRsModel =
			(ReceiptMovementRsModel)object;

		return Objects.equals(toString(), receiptMovementRsModel.toString());
	}
	...
	@Schema(
		...
		defaultValue = "io.jetprocess.dto.v1_0.ReceiptMovementRsModel",
		name = "x-class-name"
	)
