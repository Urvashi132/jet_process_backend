...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "JetProcessRs REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "JetProcessRs", version = "v1.0")
)
@Path("/v1.0")
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			...
			add(SubjectCategoryRsModelResourceImpl.class);
