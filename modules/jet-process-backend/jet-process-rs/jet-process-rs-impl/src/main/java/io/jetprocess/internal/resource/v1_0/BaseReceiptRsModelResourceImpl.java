...
public abstract class BaseReceiptRsModelResourceImpl
	implements EntityModelResource, ReceiptRsModelResource,
			   VulcanBatchEngineTaskItemDelegate<ReceiptRsModel> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/jet-process-rs/v1.0/Receipt'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/jet-process-rs/v1.0/Receipt'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/jet-process-rs/v1.0/Receipts'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "ReceiptRsModel")
	...
	public void create(
			java.util.Collection<ReceiptRsModel> receiptRsModels,
	...
	@Override
	public Page<ReceiptRsModel> read(
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseReceiptRsModelResourceImpl.class);
