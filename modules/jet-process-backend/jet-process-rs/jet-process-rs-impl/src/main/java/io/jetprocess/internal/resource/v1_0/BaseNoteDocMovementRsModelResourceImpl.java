...
public abstract class BaseNoteDocMovementRsModelResourceImpl
	implements EntityModelResource, NoteDocMovementRsModelResource,
			   VulcanBatchEngineTaskItemDelegate<NoteDocMovementRsModel> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/jet-process-rs/v1.0/notedocumentmovement'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "NoteDocMovementRsModel"
			)
		}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/notedocumentmovement")
	...
	public NoteDocMovementRsModel createNotedocMovement(
		...
		return new NoteDocMovementRsModel();
	}

	@Override
	@SuppressWarnings("PMD.UnusedLocalVariable")
	public void create(
			java.util.Collection<NoteDocMovementRsModel>
				noteDocMovementRsModels,
	...
	@Override
	public Page<NoteDocMovementRsModel> read(
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseNoteDocMovementRsModelResourceImpl.class);
