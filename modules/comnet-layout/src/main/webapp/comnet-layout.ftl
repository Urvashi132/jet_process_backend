<div class="dashboard-layout" id="main-content" role="main">
	<div class="row">
		...
		<div class="col-md-1">
				...
				<aside class="newSideBarRight float-right">            
					<ul class="profile list-unstyled">
						<li id="control-menu-right" class="mt-2 mb-2" style="display:none;" title="Show/Hide Contol Menu">                 
		                    <a id="control-panel" class="list-item text-white">
		                    	<i class="fa fa-window-maximize" aria-hidden="true" style='color: white'></i>
		                    </a>
			            </li>
						<li class="mt-2 mb-2" title="View Dashboard Widgets">
							<a id="portlet-list" class="list-item text-white">
								<i class="fa fa-cog" aria-hidden="true" style='color: white'></i>
							</a>
						</li>
						<li class="mt-2 mb-2" title="Add Custom Dashboard Page">
							<a id="add-page" class="list-item text-white">
			...
			<div id="addpage-view" style="position: absolute;right: 70px;width: 280px;mt-2; display:none;">
