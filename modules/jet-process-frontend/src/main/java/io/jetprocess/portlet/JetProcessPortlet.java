...
public class JetProcessPortlet extends MVCPortlet {
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		layoutList.forEach(c->{
			System.out.println("friendly url--"+c.getFriendlyURL());
		});
	...
	public JSONArray getJson() {
		...
		try {
			String jsonData = new String(Files.readAllBytes(Paths.get(
					"C:\\Users\\Admin\\Desktop\\liferayrestapi\\jet_process_backend\\modules\\jet-process-frontend\\src\\main\\resources\\pages.json")));
